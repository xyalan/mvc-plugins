...
/*
 * Add Enum support for convertValue
 * @see ognl.OgnlOps
 * OgnlOpsConvert.java
 * Author:Alan Yang(alanlhy@gmail.com)
 * Create Date 2013-04-16 15:29:29
 */
public class OgnlOpsConvert implements NumericTypes {
    /**
    ...
    public static Object convertValue(Object value, Class toType, boolean preventNulls) {
        ...
        if (value != null) {
            ...
            if (value.getClass().isArray() && toType.isArray()) {
                ...
                if (toType.isEnum()) result = Enum.valueOf(toType, (String) value);
            }
        } else {
